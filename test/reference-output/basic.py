...
class Recruiter:
    ...
    def validate(value: validation.Unknown) -> validation.ValidationResult['Recruiter']:
        return validation.validate_interface(value, {'type': validation.validate_literal('Recruiter'), 'name': validation.validate_string, 'emails': validation.validate_list(validation.validate_optional(validation.validate_string)), 'recruiter': validation.validate_optional(Recruiter.decode)}, Recruiter)
    ...
    def to_json(self) -> typing.Dict[str, typing.Any]:
        return {'type': 'Recruiter', 'name': self.name, 'emails': encoding.list_to_json((encoding.optional_to_json(encoding.basic_to_json)))(self.emails), 'recruiter': encoding.optional_to_json((Recruiter.to_json))(self.recruiter)}
