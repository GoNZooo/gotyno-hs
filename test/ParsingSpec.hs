...
dLangReferenceOutput = do
  ...
  pure DLangReferenceOutput {basicStruct, basicUnion, genericStruct, genericUnion}
...
spec
  ...
  (DLangReferenceOutput dBasicStruct dBasicUnion dGenericStruct dGenericUnion) = do
